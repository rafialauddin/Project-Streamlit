...
# Membaca file CSV
orders_df = pd.read_csv('F:\Dicoding\Data Science\Project\E-Commerce Public Dataset\orders_dataset.csv')
order_items_df = pd.read_csv('F:\Dicoding\Data Science\Project\E-Commerce Public Dataset\order_items_dataset.csv')
products_df = pd.read_csv('F:\Dicoding\Data Science\Project\E-Commerce Public Dataset\products_dataset.csv')
products_name_df = pd.read_csv('F:\Dicoding\Data Science\Project\E-Commerce Public Dataset\products_dataset.csv')
products_name_english_df = pd.read_csv('F:\Dicoding\Data Science\Project\E-Commerce Public Dataset\product_category_name_translation.csv')
